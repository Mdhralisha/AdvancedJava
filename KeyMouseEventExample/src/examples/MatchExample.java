...
public class MatchExample extends JFrame implements KeyListener{
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable(){
            @Override
            public void run(){
                new MatchExample().setVisible(true);
            }
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if(input_username.equals(this.username)){
            this.setOutput("Username Matched");
        }else{
            this.setOutput("Incorrect Username");
